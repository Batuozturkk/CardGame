...
# 0 Cost Mana
cards.append(Card('Hurrem Sultan', 'Give +3 point to all cards on this field.', 0, 0, hurremSultan))
...
cards.append(Card('Katip Celebi', 'Gives +2 mana when played.', 3, 4, katipCelebi))
...
cards.append(Card('Ahmed Cevdet Pasha', 'Gives +5 power to right of his field.', 3, -2, ahmedCevdetPasha))
cards.append(Card('Deliler', 'If the first card played on the field, gives 4P to field.', 3, 2, deliler))
